...
///just supporting default and pointer cursor style
...
extension HoverExtensions on Widget {
  ...
  Widget get xShowPointerOnHover => MouseRegion(
        ...
        //on mouse enter
        onHover: (event) =>
            appContainer != null ? appContainer.style.cursor = 'pointer' : '',
        //on mouse exit
        onExit: (event) =>
            appContainer != null ? appContainer.style.cursor = 'default' : '',
      );
}
